...
<header>
    ...
    <a href="login"><div class="top-menu">登</div></a>
</header>

<div class="body">

    <div class="login">
        <div class="login-title">欢迎注册转转</div>
        <form method="post" id="form1">
            ...
            <div>
                <input name="check" type="password" placeholder="请再次输入密码"/>
            </div>
            <div>
            ...
            <div>
                <button type="submit">同意条款并注册</button>
            </div>
            <div id="button1">使用邮箱注册</div>
        </form>
